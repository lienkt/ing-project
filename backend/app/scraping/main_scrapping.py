...
Usage:
    python -m app.scraping.main_scrapping
    python -m app.scraping.main_scrapping --file my_urls.txt
"""
...
from app.scraping.scrapping_pipeline import SiteConfig, run_pipeline
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Scrape text features for a list of URLs."
    )
    parser.add_argument(
        "--file",
