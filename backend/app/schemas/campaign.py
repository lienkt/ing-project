...
class DetailsInput(Schema):
    ...
    feature_vs_benefit: (
        Literal["feature_focused", "balanced", "benefit_focused"] | None
    ) = None
    emotional_vs_rational: Literal["emotional", "balanced", "rational"] | None = None
    customer_vs_product_focus: (
        Literal["customer_focused", "balanced", "product_focused"] | None
    ) = None
...
class CampaignRead(Schema):
    automation: dict[str, dict[str, bool | str | None]] = Field(default_factory=dict)
