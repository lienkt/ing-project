...
export const featureFields = [
  {
    ...
    options: ["Traditional", "Challenger", "Neobank"],
  ...
  },
  {
    ...
    kind: "enum",
    section: "Identification & Metadata",
    options: ["Dutch", "French", "English", "Other"],
  ...
  },
  {
    ...
    kind: "scale",
    section: "Text & Content",
    descriptions: ["Very simple", "Simple", "Moderate", "Complex", "Very complex"],
  ...
  },
  {
    ...
    kind: "enum",
    section: "Messaging & Tone",
    options: ["Product", "Feature", "Benefit", "Lifestyle", "Price"],
  ...
  },
  {
    ...
    kind: "enum",
    section: "Images & Visuals",
    options: ["Photography", "Illustration", "3D", "UI-Product", "Mixed"],
  ...
  },
  {
    ...
    kind: "scale",
    section: "Colour & Design",
    descriptions: ["Very minimal", "Simple", "Moderate", "Complex", "Very complex"],
  ...
  },
  {
    ...
    kind: "enum",
    section: "Colour & Design",
    options: ["Text", "Image", "CTA", "Product", "Mixed"],
  ...
  },
  {
    ...
    kind: "enum",
    section: "Layout & Page Structure",
    options: ["Text-first", "Image-first", "Alternating", "Cards", "Mixed"],
  ...
  },
  {
    ...
    kind: "scale",
    section: "Layout & Page Structure",
    descriptions: ["Very difficult", "Difficult", "Average", "Easy", "Very easy"],
  ...
  },
  {
    ...
    kind: "enum",
    section: "Call to Action",
    options: ["Apply", "Buy", "Open", "Learn", "Contact", "Calculate", "Other"],
...
type Value<F extends Definition> = F extends { kind: "scale" | "count" | "derived" }
  ? number
...
export type FeatureRecord = FeatureInput & {
  ...
  source: "manual" | "automatic" | "manual_override";
  created_at: string;
  updated_at: string;
};
export type FeatureResponse = {
  ...
  labeling_status: LabelingStatus;
  progress: number;
  missing_fields: FeatureKey[];
};
export const emptyFeatures = Object.fromEntries(
  featureFields.map((f) => [f.key, null]),
) as FeatureValues;
...
export const completeFeatures = (id: string, confirm_incomplete: boolean) =>
  request<FeatureResponse>(`/campaigns/${id}/features/complete`, "POST", {
    confirm_incomplete,
  });
