...
See [collection architecture and function handoff](collection-workflow.md) for import snapshots and pending suggestions, which remain separate from CampaignFeature.
